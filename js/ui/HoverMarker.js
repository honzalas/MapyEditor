        ...
        if (!this._marker) {
            this._marker = L.marker([lat, lon], {
                icon: L.divIcon({
                    ...
                    html: `<div style="width: 18px; height: 18px; background: rgba(76, 175, 80, 0.95); border: 2.5px solid white; border-radius: 50%; box-shadow: 0 1.5px 6px rgba(0,0,0,0.5); display: flex; align-items: center; justify-content: center; cursor: default; pointer-events: auto;">
